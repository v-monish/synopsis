...
# Test the function
summary = "summary.\n\n.Summary is statiucs. This is good.\n\nHai"
output = process_summary(summary)
print(type(output))
...
data =[
    {
        ...
        "arabicSummary": "استناداً إلى تحليل نتائج امتحانات الداخلية لعام 2023، فإن الطلاب في المدارس الابتدائية لديهم معدلات مهارة تتراوح بين 35% في الرياضيات G4 و 91% في الرياضيات والعلوم G2، في حين أن في المدارس المتوسطة تتراوح النسبة بين 27% في الرياضيات G5 و 90% في الرياضيات G6. في المدرسة الثانوية، تكون معدلات الكفاءة منخفضة جداً في معظم المواد، حيث تتراوح بين 6% في الحسابات والتمويل والبنوك في G11 و 87% في اللغة الإنجليزية G9. نسبة الكفاءة تتراوح بين 6% في الاقتصاد و 100% في الفيزياء. نسبة الكفاءة في المواد الأساسية في عدد قليل من الدرجات في الامتحانات الداخلية لعام 2023، ولا سيما في الدرجات 4.9 و 11، تحتاج إلى تحسين. التقدم الذي أحرزته الطلاب ذوي الأداء المنخفض في الدروس غير متسق بسبب استراتيجيات التدريس والدعم غير المتسقين. تتوافق اللغة الإنجليزية والمهارات الحسابية ومعايير الطلاب في العلوم مع توقعات المناهج الدراسية. ومع ذلك، فإن معدلات الكفاءة في المواد الأساسية في عدد قليل من الدرجات في عام 2023"
    },
    {
